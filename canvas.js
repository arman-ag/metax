...
//     console.log(stageSize)
//     return (
//         <div style={{ display: 'flex', justifyContent: 'center', backgroundColor: "black", width: 700, height: 300 }} ref={canvasContainer}>
//             <Stage width={700} height={300} scale={
//                 { x: .37, y: .28 }}  >
//                 < Layer >
//                     <ResultImage />
